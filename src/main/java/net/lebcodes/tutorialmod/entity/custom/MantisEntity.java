package net.lebcodes.tutorialmod.entity.custom;
...
public class MantisEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        //higher priority (smaller value) means it will get executed first
        //look at goal class to see every goal in vanilla minecraft
